...
public class ControllerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userPath.equals("/addToCart")) {
            ...
            else if(userPath.equals("/privacypolicy")){
                    
                    userPath = "/privacypolicy";
            
            // if oauthLogin is called
        }else if(userPath.equals("/oauthlogin")){
            ...
            List details = loginManager.getDetails();
            ...
            //if oauth action is called
        }else if(userPath.equals("/oauth")){
            String name = request.getParameter("name");
            String email = request.getParameter("email");
            String password = request.getParameter("password");
            String confirmPassword =  request.getParameter("confirmPassword");
                    
            int loginId = loginManager.Register(name, email, password, confirmPassword);
