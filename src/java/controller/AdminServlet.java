...
//        }
//        
//        if (userPath.equals("/admin/addthis")) {
//            
...
//            
//            int productId = productManager.addProduct(name, BigDecimal.valueOf(price), description, category_id);
//            
//            if(productId != 0){
//                userPath = "admin/customerRecord";
//            }else
...
//        }
        ...
        if (userPath.equals("/admin/logout")) {
            ...
            response.sendRedirect("/ZeroStore/admin/");
            return;
        }
