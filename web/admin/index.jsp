...
<div id="adminMenu" class="alignLeft">
    <%--  <p><a href="<c:url value='addProduct'/>">Add Product</a></p>--%>
...
<%--<div>
    <c:when test=""></c:when>
        <form action="<c:url value="/admin/addthis"/>" method="POST">
            ...
            <tr>
                <td><label for="price">Price per Unit(in &#8377;):</label></td>
                <td class="inputField">
                    <input type="number"
                           size="31"
                           maxlength="10"
            ...
            <tr>
                ...
                <td class="inputField">
                    <select name="category_id" maxlength="3">
                        <option value= "1" selected="selected">Hardware</option>
